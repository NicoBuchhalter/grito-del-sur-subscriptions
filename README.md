...
- Clone the repository by running `git clone git@github.com:NicoBuchhalter/grito-del-sur-subscriptions.git`
- Go to the project root by running `cd grito-del-sur-subscriptions`
...
```bash
  ...
  CREATE ROLE "grito-del-sur-subscriptions" LOGIN CREATEDB PASSWORD 'grito-del-sur-subscriptions';
```
...
This project is maintained by [Nicolás Buchhalter](https://github.com/NicoBuchhalter) and it is written by [Grito del Sur](http://elgritodelsur.com.ar/).

![Grito del Sur](http://elgritodelsur.com.ar/wp-content/uploads/2017/07/logochico.png)
